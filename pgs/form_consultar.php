<?php include ('../inc/header.php') ?> 
        <div class="container col-md-6 mt-4 border border-3 border-dark shadow shadow-5 border-opacity-75 p-5">
            <form name="produto" action="<?php echo PATH?>consultar.php" method="post">
                <div>
                    <label for="id">ID do Produto que Deseja consultar</label><br>
                    <input class="fo form-control border border-dark" type="number" name="id" id="id" required><br>
